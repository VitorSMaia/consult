<div>
    <section class="p-5">
        <div class="flex justify-end items-center">
            @permission(['meeting_rooms_create'])
            <x-button
                wire:click="openModal('meeting-rooms.form', {'title':'Cadastro de Sala'})"
                label="Cadastrar"
                icon="add"
        ...
        <div class="shadow-lg">
            <table class="w-full">
                ...
                <tr>
                    ...
                    @permission(['meeting_rooms_edit', 'meeting_rooms_delete'])
                ...
                @foreach($response->itens as $item)
                    <tr>
                        ...
                        <td class="flex justify-start items-center gap-x-2">
                            ...
                            @permission(['meeting_rooms_delete'])
                            <x-button-icon
