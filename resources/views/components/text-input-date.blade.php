...
<div class="relative z-10 w-full bg-transparent border-0">
    <input
        ...
        placeholder=""
        autocomplete="true"
        class="datepicker w-full h-max block p-0 m-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200"
    />
